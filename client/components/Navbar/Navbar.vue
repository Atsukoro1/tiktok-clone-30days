<template>
    <nav class="bg-white fixed top-0 w-full">
        ...
        <div class="relative flex h-16 items-center justify-between">
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4 flex-row justify-center align-center">
                <Link v-for="link in links"
                  :key="link.text"
                  :text="link.text"
                  :link="link.link"
                  :highlighted="link.hightlighted"
                />
              </div>
            </div>
          </div>
      ...
      <div class="sm:hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 flex flex-row justify-center align-center">
          <Link v-for="link in links"
            :key="link.text"
            :text="link.text"
            :link="link.link"
